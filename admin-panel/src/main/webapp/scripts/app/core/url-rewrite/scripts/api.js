define(['knockout', 'gc/gc'], function (ko, gc) {
	...
	return {
        ...
        createURLRewrite: function(newURLRewrite) {
			self = this;
        ...
        updateURLRewrite: function(id, updateModel) {
			self = this;
        ...
        getPagingOptions: function(pagingOptions) {
            ...
            return {
                ...
                fields: pagingOptions.fields  || ['requestURI', 'requestMethod', 'targetURL', 'targetObjectId', 'targetObjectType', 'flags', 'enabled'],
