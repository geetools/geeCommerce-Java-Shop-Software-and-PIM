define(['knockout', 'gc/gc'], function (ko, gc) {
	...
	return {
        ...
        getParameterOptions: function(widgetCode, parameterId) {
            self = this;
            ...
            gc.rest.get({
                url : '/api/v1/widgets/' + widgetCode + '/options/' + parameterId,
                success : function(data, status, xhr) {
                    if (self._onload) {
                        self._onload(data, status, xhr);
                    }
