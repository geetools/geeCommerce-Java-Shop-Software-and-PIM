define(['knockout', 'gc/gc'], function (ko, gc) {
    ...
    return {
        ...
        createContentLayout: function (updateModelData) {
            self = this;
        ...
        updateContentLayout: function (id, updateModelData) {
            self = this;
        ...
        removeContentLayout: function(id) {
            var self = this;
