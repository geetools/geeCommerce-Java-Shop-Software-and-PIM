define(['knockout', 'gc/gc'], function (ko, gc) {
    ...
    return {
        ...
        createContent: function (updateModelData) {
            self = this;
        ...
        updateContent: function (contentId, updateModelData) {
            self = this;
        ...
        getRewriteUrl: function(contentId) {
            var self = this;
            ...
            gc.rest.get({
                url : '/api/v1/contents/' + contentId + '/url',
                success : function(data, status, xhr) {
                    if (self._onload) {
                        self._onload(data, status, xhr);
                    }
        ...
        updateRewriteUrl: function(contentId, updateModel) {
            var self = this;
        ...
        isUrlUnique: function(contentId, updateModel) {
            var self = this;
            ...
            var url = '/api/v1/contents/url/validation';

            if(contentId)
                url = '/api/v1/contents/' + contentId + '/url/validation'
        ...
        pagingOptions: function(options) {
            ...
            return {
                ...
                url: '/api/v1/contents',
                searchUrl: '/api/v1/search/contents',
                filter: options.filter || [],
                // Only load specific fields for better performance.
                fields: options.fields || [ 'id', 'key', 'name'],
