define(['knockout', 'gc/gc'], function (ko, gc) {
    ...
    return {
        getMediaAssetDirectories: function() {
            var self = this;
        ...
        getMediaAssetDirectory: function(id) {
            var self = this;
            ...
            gc.rest.get({
                url : '/api/v1/media-asset-directories/' + id,
                success : function(data, status, xhr) {
                    if (self._onload) {
                        self._onload(data, status, xhr);
                    }
        ...
        getMediaAssets: function(directoryId) {
            var self = this;
            ...
            gc.rest.get({
                url : '/api/v1/media-assets/' + directoryId + "/list/",
                success : function(data, status, xhr) {
                    if (self._onload) {
                        self._onload(data, status, xhr);
                    }
        ...
        removeMediaAssetDirectory: function(id) {
            var self = this;
        ...
        removeAsset: function(id, mediaAssetId) {
            ...
            gc.rest.del({
                url : '/api/v1/media-assets/' + mediaAssetId + '/assets/' + id,
                success : function(data, status, xhr) {
                    if (self._onload) {
                        self._onload(data, status, xhr);
                    }
        ...
        updateMediaAssetFromUrl: function(id, url) {
            var self = this;
            ...
            gc.rest.get({
                url : '/api/v1/media-assets/update-file-url/' + id + "?url=" + url,
        ...
        updateMediaAsset: function(mediaAssetId, updateModel) {
            var self = this;
        ...
        createMediaAssetDirectory: function(newMediaAssetDirectory) {
            var self = this;
        ...
        updateMediaAssetDirectory: function(mediaAssetDirectoryId, updateModel) {
            var self = this;
        ...
        // ----------------------------------------------------------------
        pagingOptions: function(directoryId, options) {
            ...
            return {
                ...
                url: '/api/v1/media-assets/' + directoryId + "/list/",
                searchUrl: '/api/v1/media-assets/search',
                filter: options.filter || [],
                // Only load specific fields for better performance.
                //fields: options.fields || [ 'id', 'name', 'url', 'webThumbnailPath', 'mimeType', 'size' ],
