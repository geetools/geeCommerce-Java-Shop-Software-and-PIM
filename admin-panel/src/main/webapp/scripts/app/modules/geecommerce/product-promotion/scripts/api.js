define(['knockout', 'gc/gc'], function (ko, gc) {
    ...
    return {
        getProductPromotion: function(productPromotionId) {
            var self = this;
            ...
            gc.rest.get({
                url : '/api/v1/product-promotions/' + productPromotionId,
        ...
        updateProductPromotion: function(productPromotionId, updateModel) {
            var self = this;
        ...
        removeProductPromotion: function(productPromotionId) {
			var self = this;
			...
			console.log('_____removeProductPromotion_____', productPromotionId);
        ...
        createProductPromotion: function(updateModel) {
            var self = this;
        ...
        uploadTeaser: function(productPromotionId, formData) {
            var self = this;
            ...
            gc.rest.file({
                url : '/api/v1/product-promotions/' + productPromotionId + '/teasers',
                data : formData,
        ...
        removeTeaser: function(productPromotionId) {
            var self = this;
