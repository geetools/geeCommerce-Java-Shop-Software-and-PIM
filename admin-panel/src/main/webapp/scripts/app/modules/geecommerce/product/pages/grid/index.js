...
//			return txt;
	    ...
	    activate: function(data) {
            ...
            attrAPI.getAttributes('product', { fields : [ 'code', 'code2', 'backendLabel', 'editable', 'enabled', 'inputType', 'frontendInput', 'optionAttribute', 'allowMultipleValues', 'i18n', 'options', 'tags', 'label' ], filter: { code : "product_group, programme" } } ).then(function( response ) {
			...
			this.gridTableMenuItems = [
	              ...
	              {key:'menu-item-select', icon: 'fa fa-check-square-o', label: 'app:gridTable.menuItemSelect', target: '', targetType: '', contextMenu: [{text: '<span class="chbx-page-select-all"><i class="fa fa-check-square-o" aria-hidden="true"></i>Select all rows on this page</span>', action: function() {}}, {text: '<i class="chbx-pages-select-all fa fa-check-square-o" aria-hidden="true"></i>Select rows on all pages', action: function() {}}, {text: '<i class="chbx-unselect-all fa fa-square-o" aria-hidden="true"></i>Deselect all rows', action: function() {}}]},
	              {key:'menu-item-actions', icon: 'fa fa-tasks', label: 'app:gridTable.menuItemActions', target: '', targetType: '', contextMenu: [{text: '<i class="fa fa-clone" aria-hidden="true"></i>Batch update attributes', action: function() { gc.app.showAttrBatchUpdaterModal(true) }}]},
	              {key:'menu-item-import', icon: 'fa fa-download', label: 'app:gridTable.menuItemImport', target: '', targetType: '', contextMenu: [{text: '<i class="fa fa-download" aria-hidden="true"></i>Import data', url: '#/products/import' }]},
