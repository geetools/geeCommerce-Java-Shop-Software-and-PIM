...
public enum DmaMongo {
	...
	if (mongoClient == null) {
		...
		mongoClient = new MongoClient(new ServerAddress(SystemConfig.GET.val(SystemConfig.MONGODB_DMA_HOST), SystemConfig.GET.intVal(SystemConfig.MONGODB_DMA_PORT)), options);
	    } catch (Throwable t) {
