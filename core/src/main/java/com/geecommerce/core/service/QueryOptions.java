...
public class QueryOptions {
    ...
    public QueryOptions(List<Id> limitToMerchants, List<Id> limitToStores, List<Id> limitToRequestContexts, Map<String, List<Id>> limitAttributesToStores, List<String> fieldsToInclude, List<String> fieldsToExclude, List<String> attributesToInclude,
	    List<String> attributesToExclude, String distinctField, List<String> sortAsc, List<String> sortDesc, Long offset, Integer limit, Boolean fetchIdsOnly, Boolean provideCount, String singleQueryField, Boolean refresh, Boolean noCache,
	...
	return sortAsc + ", " + sortDesc + "," + offset + "," + limit + ", " + limitToMerchants + ", " + limitToStores + ", " + limitToRequestContexts + ", " + limitAttributesToStores + ", " + fetchIdsOnly;
    }

    @Override
    public String toString() {
	return "QueryOptions [limitToMerchants=" + limitToMerchants + ", limitToStores=" + limitToStores + ", limitToRequestContexts=" + limitToRequestContexts + ", limitAttributesToStores=" + limitAttributesToStores + ", fieldsToInclude="
		+ fieldsToInclude + ", fieldsToExclude=" + fieldsToExclude + ", attributesToInclude=" + attributesToInclude + ", attributesToExclude=" + attributesToExclude + ", distinctField=" + distinctField + ", sortAsc=" + sortAsc
		+ ", sortDesc=" + sortDesc + ", offset=" + offset + ", limit=" + limit + ", fetchIdsOnly=" + fetchIdsOnly + ", provideCount=" + provideCount + ", singleQueryField=" + singleQueryField + ", numFieldsSet=" + numFieldsSet + ", refresh="
		+ refresh + ", noCache=" + noCache + ", fromCacheOnly=" + fromCacheOnly + "]";
    }
	...
	public QueryOptions build() {
	    return new QueryOptions(limitToMerchants, limitToStores, limitToRequestContexts, limitAttributesToStores, fieldsToInclude, fieldsToExclude, attributesToInclude, attributesToExclude, distinctField, sortAsc, sortDesc, offset, limit,
		    fetchIdsOnly, provideCount, singleQueryField, refresh, noCache, fromCacheOnly);
	}
    }
}
