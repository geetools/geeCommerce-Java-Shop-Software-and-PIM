...
public class DefaultStore extends AbstractModel implements Store {
    ...
    public DefaultStore(final Id id, final String code, final String name, final String defaultLanguage, final String iconPathXS, final String iconPathS, Id parentStoreId) {
	this.id = id;
	this.code = code;
	this.name = name;
	...
	return new StringBuilder(merchant.getTemplatesPath()).append(File.separatorChar).append(Char.UNDERSCORE).append(Filenames.ensureSafeName(getCode() != null ? getCode() : getName(), true)).toString();
    }
	...
	return new StringBuilder(merchant.getResourcesPath()).append(File.separatorChar).append(Char.UNDERSCORE).append(Filenames.ensureSafeName(getCode() != null ? getCode() : getName(), true)).toString();
    }
