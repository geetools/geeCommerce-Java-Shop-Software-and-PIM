...
public class FreemarkerCache implements CacheStorage {
	...
	// if(value != null)
	// {
	// System.out.println("FREEMARKER FROM CACHE - " + ReflectionToStringBuilder.toString(key));
	// } else {
	// System.out.println("FREEMARKER NOT FROM CACHE - " + ReflectionToStringBuilder.toString(key));
	// }
	return value;
    }
