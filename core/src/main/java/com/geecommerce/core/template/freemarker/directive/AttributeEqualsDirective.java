...
public class AttributeEqualsDirective implements TemplateDirectiveModel {
    ...
    public void execute(Environment env, Map params, TemplateModel[] loopVars, TemplateDirectiveBody body)
        ...
        try {
            if (source != null && sourceAttrValue == null) {
                ...
                if (sourceAttrValue == null && fallbackToParent) {
                ...
                // interface.
                if (sourceAttrValue == null && childLookup != null && !CHILD_LOOKUP_NONE.equals(childLookup)) {
                    ...
                    if (children != null && children.size() > 0) {
                        if (CHILD_LOOKUP_FIRST.equals(childLookup)) {
                            ...
                            if (children != null && children.size() != 0) {
                                ...
                                // found.
                                if (sourceAttrValue == null && childLevels != null && childLevels > 1) {
            ...
            if (sourceAttrValue != null) {
                srcValue = sourceAttrValue.getVal();
            }
        } catch (Throwable t) {
        ...
        if (srcValue != null && srcValue.equals(targetValue) && body != null) {
