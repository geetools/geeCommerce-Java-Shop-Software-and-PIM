...
public class URI_PREFIX_ONLY extends AbstractURLParser implements URLParser {
    private static final Logger log = LogManager.getLogger(URI_PREFIX_ONLY.class);
