...
public class Regex {
    ...
    /**
     * Replaces all found substrings in a text with a given replacement. This method simply passes the regex handling onto javax.util.regex.Matcher,
    ...
    /**
     * Replaces the first found substring in a text with a given replacement. This method simply passes the regex handling onto
     * javax.util.regex.Matcher, but caches the compiled pattern for reuse to increase performance.
     * 
     * @param text
     * @param pattern
     * @param replacement
	...
	String s = text.replace("ä", "ae").replace("ö", "oe").replace("ü", "ue").replace("Ä", "Ae").replace("Ö", "Oe").replace("Ü", "Ue").replace("ß", "ss").replace("@", "a").replace("&", "and");
    ...
    /**
     * Check if the given pattern is found in a text using java.util.regex classes. This method simply passes the regex handling onto
     * javax.util.regex.Matcher, but caches the compiled pattern for reuse to increase performance.
     * 
     * @param text
     * @param pattern
    ...
    /**
     * Returns a string of debug output containing all of the cached regular expressions.
     * 
     * @return debug string
     */
