...
@Widget(name = "product_list_top_filter")
public class ProductListTopFilterWidget extends AbstractWidgetController implements WidgetController {
    ...
    public ProductListTopFilterWidget() {
    ...
    public void execute(WidgetContext widgetCtx, HttpServletRequest request, HttpServletResponse response, ServletContext servletContext) throws Exception {
        ...
        String is_mobile = widgetCtx.getParam("is_mobile");
        ...
        if (!Str.isEmpty(view)) {
            ...
            widgetCtx.render("product/list_top_filter");
        }
