...
@Dao
@Persistence(name = "mysql", model = Price.class)
@Implements(PriceDao.class)
public class DefaultPriceMySqlDao extends DefaultMySqlDao implements PriceDao {
    private static final String TABLE_NAME = "price";

    @Inject
    public DefaultPriceMySqlDao(Connections connections, CacheManager cacheManager) {
