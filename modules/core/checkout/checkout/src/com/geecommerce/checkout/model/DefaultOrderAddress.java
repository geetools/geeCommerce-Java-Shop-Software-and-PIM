...
public class DefaultOrderAddress extends AbstractModel implements OrderAddress {
	...
	return "DefaultOrderAddress [id=" + id + ", orderId=" + orderId + ", firstName=" + firstName + ", lastName=" + lastName + ", zip=" + zip + ", address1=" + address1 + ", address2=" + address2 + ", city=" + city + ", country=" + country
		+ ", type=" + type + "]";
    }
}
