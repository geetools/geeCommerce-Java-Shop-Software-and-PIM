            ...
            <#list paymentMethods as paymentMethod>
                <div class="row payment-row">
                    <div class="col-sm-3 col-xs-12">
                        <div class="radio">
                            <label>
                                <#if form.paymentMethodCode?? && form.paymentMethodCode == paymentMethod.code>
                                    <input type="radio" value="${paymentMethod.code}" name="form.paymentMethodCode" required checked/><span></span>
                                <#else>
