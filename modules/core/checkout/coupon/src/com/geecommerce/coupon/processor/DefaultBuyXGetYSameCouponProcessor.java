...
public class DefaultBuyXGetYSameCouponProcessor extends BaseCouponProcessor implements CouponProcessor {
	...
	if (nullCheck(couponCode) && couponCode.getCoupon().getCouponAction().getType().equals(CouponActionType.BUY_X_GET_Y_FREE_SAME) && couponCode.getCoupon().getCouponAction().getDiscountQtyStep() != null
