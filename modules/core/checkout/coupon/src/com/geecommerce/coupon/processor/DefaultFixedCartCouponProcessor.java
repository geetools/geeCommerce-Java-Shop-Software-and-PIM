...
public class DefaultFixedCartCouponProcessor extends BaseCouponProcessor implements CouponProcessor {
    @Override
	...
	if (nullCheck(couponCode) && couponCode.getCoupon().getCouponAction().getType().equals(CouponActionType.FIXED_CART))
	    return true;
	return false;
    }
	...
	calcCtx.addParameter(ParamKey.CART_DISCOUNT_AMOUNT, couponAction.getDiscountAmount());
