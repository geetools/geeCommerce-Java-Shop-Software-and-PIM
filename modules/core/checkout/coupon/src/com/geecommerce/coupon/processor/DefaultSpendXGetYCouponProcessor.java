...
public class DefaultSpendXGetYCouponProcessor extends BaseCouponProcessor implements CouponProcessor {
	...
	if (nullCheck(couponCode) && couponCode.getCoupon().getCouponAction().getType().equals(CouponActionType.SPEND_X_GET_Y_FREE) && couponCode.getCoupon().getCouponAction().getDiscountQtyStep() != null
