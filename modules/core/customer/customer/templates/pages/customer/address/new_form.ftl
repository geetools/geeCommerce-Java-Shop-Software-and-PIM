...
<div class="customer-account-container">
    <div class="row center-block">
        <div class="col-xs-12">
            <div class="row">
                <h1 class="h1"><@message text='Add new address' lang="en" text2="Eine neue Adresse eingeben" lang2="de"/></h1>
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">

                    <@f.form action="/customer/address/add" method="post" ssl=true class="form-horizontal"
                    ...
                    fieldErrorClass="help-block">
                        ...
                        <input type="hidden" name="<@csrf.tokenname/>"
                               value="<@csrf.tokenvalue uri="/customer/address/add"/>"/>
                            ...
                            <div class="row">
                                <div class="col-xs-12 ">
                                    ...
                                    <div class="col-sm-offset-6 col-xs-12 col-sm-6">
                                        <div class="checkbox">
                                            <label>
                                                <@f.checkbox name="addressForm.defaultInvoiceAddress" value="true"
                                                class="someClass" group="def-address-type" id="ac-addr-def-invoice" fieldOnly=true/>
                                                <@message text="Set address as default invoice address" lang="en"
                                            text2="Set-Adresse als Standard-Rechnungsadresse" lang2="de"/>
                                            </label>
                                        </div>
                                    </div>
                                </div>
