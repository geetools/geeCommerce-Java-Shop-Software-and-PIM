...
@Widget(name = "cms_product_carousel", cms = true, css = true, js = true)
public class CmsProductCarouselWidget extends AbstractWidgetController implements WidgetController {

    private final String PARAM_PRODUCT = "product_id";
    private final ProductService productService;

    @Inject
    public CmsProductCarouselWidget(ProductService productService) {
