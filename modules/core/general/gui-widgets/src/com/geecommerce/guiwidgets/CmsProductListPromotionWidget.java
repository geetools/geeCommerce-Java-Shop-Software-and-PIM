...
public class CmsProductListPromotionWidget extends AbstractWidgetController implements WidgetController {
    ...
    public void execute(WidgetContext widgetCtx, HttpServletRequest request, HttpServletResponse response,
        ...
        if (productListId != null && !productListId.isEmpty()) {
            ...
            // productPromotionService.getProducts(productPromotion);
        }

        /*
         * String promotionKey = widgetCtx.getParam(PARAM_KEY);
         * widgetCtx.setParam("productPromotionKey", promotionKey); String
         * promotionTemplate = widgetCtx.getParam(PARAM_TEMPLATE); if
         * (promotionKey != null && !promotionKey.isEmpty() && promotionTemplate
         * != null && !promotionTemplate.isEmpty()) { List<ProductPromotion>
         * productPromotions =
         * productPromotionService.getProductPromotionByKey(promotionKey); if
         * (productPromotions != null && productPromotions.size() != 0) {
         * ProductPromotion productPromotion = productPromotions.get(0);
         * List<Product> products =
         * productPromotionService.getProducts(productPromotion); if (products
         * != null && products.size() != 0) { widgetCtx.setParam("products",
         * products);
         * 
