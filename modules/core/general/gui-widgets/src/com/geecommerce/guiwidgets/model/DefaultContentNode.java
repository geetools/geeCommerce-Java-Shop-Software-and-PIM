...
/*
    private void fixParams(Map<String, Object> map) {
	if (map.containsKey("widget")) {
	    if (this.parameters == null)
		this.parameters = new HashMap<>();

	    Map<String, Object> widget = map_(map.get("widget"));
	    List<Map<String, Object>> parameters = list_(widget.get("parameters"));
	    for (Map<String, Object> parameter : parameters) {
		this.parameters.put(str_(parameter.get("code")), str_(parameter.get("value")));
	    }
	}
    }
*/
...
/*	fixParams(map);
 ...
 /*   map.put(Col.CSS, getCss());*/
	...
	/*map.put(Col.TYPE2, getType2());
	List<Map<String, Object>> nodesList = new ArrayList<>();
	if (getNodes() != null) {
	    for (ContentNode node : getNodes()) {
