...
public interface OptivoMailerService extends Service {
    String invoke(String operation, String authCode, Map<String, Object> parameters)
    ...
    String sendTransactionMail(String recipientId, String attachmentToken, Map<String, Object> recipientParams)
        throws MailerServiceException, IOException;

    String sendTransactionMail(String recipientId, String mailingId, String attachmentsToken,
    ...
    String subscribe(String recipientId, String optinId, boolean failOnUnsubscribe, boolean overwrite,
        String optinSource, Map<String, String> params) throws MailerServiceException, IOException;

    String unsubscribe(String recipientId, String mailId, boolean removeId) throws MailerServiceException, IOException;

    String updateFields(String recipientId, String newRecipientId, boolean overwrite, Map<String, String> params)
        throws MailerServiceException, IOException;
    ...
    String onlineVersion(String recipientId, String pattern, String mailingId)
