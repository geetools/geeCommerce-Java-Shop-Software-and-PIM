package com.geecommerce.checkout.pm.banktransfer;

import java.util.Map;

import com.geecommerce.checkout.model.Order;
import com.geecommerce.checkout.pm.banktransfer.configuration.Key;
...
@PaymentMethod
public class BankTransfer extends AbstractPaymentMethod {
    @Inject
    protected App app;
    ...
    public String getCode() {
        return "scs_bank_transfer";
    }

    @Override
    public String getLabel() {
        return app.message("Bank Transfer");
    }
