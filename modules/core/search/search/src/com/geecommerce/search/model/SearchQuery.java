...
public class SearchQuery {
    ...
    public SearchQuery(String searchPhrase, Map<String, Object> filter, Integer offset, Integer limit, String sort, Double priceFrom, Double priceTo, boolean showEvent, boolean showSale) {
	this.searchPhrase = searchPhrase;
	this.filter = filter;
	this.offset = offset;
	this.limit = limit;
