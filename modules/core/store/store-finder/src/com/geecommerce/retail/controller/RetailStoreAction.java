...
public class RetailStoreAction extends BaseActionBean {
    ...
    @Inject
    public RetailStoreAction(RetailStoreService retailStoreService, MediaAssetService mediaAssetService,
    ...
    public Resolution view() {
        if (getId() != null) {
            ...
            RetailStoreViewBuilder retailStoreViewBuilder = new RetailStoreViewBuilder(mediaAssetService,
                locationService);
