...
<link href="<@skin path="css/bootstrap4/bootstrap.min.css"/>" rel="stylesheet">
<link href="<@skin path="css/font-awesome/css/font-awesome.min.css"/>" rel="stylesheet">
...
<link href="<@skin path="css/gc_cms.css"/>" rel="stylesheet">
...
<script src="/web/js-app-cms?v=${v?long}"></script>
